...
def find_word_in_file(url, word):
    ...
    if response.status_code == 200:
        ...
        if word in file_content:
            ...
            print(f"[bold white][[bold blue]✓[bold white]][bold green] Login SucessFull Your Id is  [italic blue]{word}")
            time.sleep(5.55)
            pass
...
url = "https://raw.githubusercontent.com/MR-S74RK/FB-HACK/main/.user/users.txt"  
